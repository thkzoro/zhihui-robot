...
class PAJ7620 {
public:
    PAJ7620(i2c_bus_handle_t bus, uint8_t dev_addr);
    ~PAJ7620() {}

    uint8_t init(void);
    void selectBank(int bank);
    uint8_t writeReg(uint8_t addr, uint8_t cmd);
    uint8_t readReg(uint8_t addr, uint8_t data_len, uint8_t data[]);
