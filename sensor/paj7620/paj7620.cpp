...
{
    uint8_t write_buf[2] = {addr, cmd};
    int ret = i2c_master_write_to_device(m_ioCfg.i2c_id, PAJ7620_ID, write_buf, sizeof(write_buf), I2C_MASTER_TIMEOUT_MS / portTICK_RATE_MS);
 ...
 * Return: error code; success: return 0
****************************************************************/ 
uint8_t PAJ7620::readReg(uint8_t addr, uint8_t qty, uint8_t data[])
{
    return i2c_master_write_read_device(m_ioCfg.i2c_id, PAJ7620_ID, &addr, 1, data, qty, I2C_MASTER_TIMEOUT_MS / portTICK_RATE_MS);
}
...
bool PAJ7620::i2c_init()
{
    i2c_config_t conf = {
            .mode = I2C_MODE_MASTER,
            .sda_io_num = m_ioCfg.i2c_sda,
...
uint8_t PAJ7620::init(void) 
{
	...
	//wakeup the sensor
	delay_ms(1);	//Wait 700us for PAJ7620U2 to stabilize
